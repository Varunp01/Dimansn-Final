...
function Cards() {
  ...
  return (
    <>
      <div className="mt-0 sm:mt-0 Cards w-full flex justify-center items-center text-black flex-wrap">
        <div className="Card flex justify-center items-center mx-3 w-[350px] py-3 mb-3 shadow-2xl">
