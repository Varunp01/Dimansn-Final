    ...
    <>
      <div className="HowWeWork mt-20 flex justify-center items-center" id='HowWeWork'>
        ...
        <div className="">
          ...
          <div className=" flex justify-center items-center my-8 mx-4 inter font-normal text-[16px]">Our process is a collaborative journey, from the initial concept to the final realization.</div>
