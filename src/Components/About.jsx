...
function About() {
  return (
    <section className=" flex flex-col md:flex-row w-full bg-gray-100 py-16" id="AboutUs">
      {/* Image Section */}
      <div className="relative h-[400px] md:h-auto md:w-1/2 flex justify-center items-center md:ml-10">
        <img
          src="https://i.ibb.co/JvphQSc/Mask-group.png"
          alt="Mask-group"
          className="md:w-1/3 w-2/3 transform transition-transform hover:scale-105 duration-300 absolute top-0 left-2 md:top-10"
        />
        <img
          src="https://i.ibb.co/Byk8s16/Mask-group-1.png"
          alt="Mask-group-1"
          className="md:w-1/3 w-2/3 transform transition-transform hover:scale-105 duration-300 absolute top-20 md:top-28"
        />
      </div>

      {/* Content Section */}
      <div className="md:w-1/2 flex flex-col justify-center items-start px-6 sm:px-12 lg:px-20 space-y-6">
